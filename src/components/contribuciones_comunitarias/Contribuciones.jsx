...
const Contribuciones = ({ people, viewOnly }) => {
    ...
    const handleGetContributionData = useCallback(async () => {
        try {
            ...
            if (responseJson.message !== null) {
                setContribucionesCulturales(JSON.parse(responseJson.message.contribuciones_culturales));
                setAportesEducativos(JSON.parse(responseJson.message.aportes_educativos));
                setDesarrolloEmpresarial(JSON.parse(responseJson.message.desarrollo_empresarial));
                setTrabajoFilantropico(JSON.parse(responseJson.message.trabajo_filantropico));
                setLiderazgoReligioso(JSON.parse(responseJson.message.liderazgo_religioso));
                setActividadesDeportivas(JSON.parse(responseJson.message.actividades_deportivas));
            }
        }
        catch (error) {
    ...
    }, [people, token, dispatch, setCargando, setContribucionesCulturales, setAportesEducativos, setDesarrolloEmpresarial, setTrabajoFilantropico, setLiderazgoReligioso, setActividadesDeportivas]);
    ...
    const handlePutContributionData = useCallback(async () => {
        try {
            ...
            const requestBody = JSON.stringify({
                'people_id': String(people.id),
                'contribuciones_culturales': JSON.stringify(contribucionesCulturales),
                'aportes_educativos': JSON.stringify(aportesEducativos),
                'desarrollo_empresarial': JSON.stringify(desarrolloEmpresarial),
                'trabajo_filantropico': JSON.stringify(trabajoFilantropico),
                'liderazgo_religioso': JSON.stringify(liderazgoReligioso),
                'actividades_deportivas': JSON.stringify(actividadesDeportivas)
            });
    ...
    }, [people, token, contribucionesCulturales, aportesEducativos, desarrolloEmpresarial, trabajoFilantropico, liderazgoReligioso, actividadesDeportivas, dispatch, setCargando]);
