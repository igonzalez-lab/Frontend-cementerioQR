...
const Festividades = ({ people, viewOnly }) => {
    ...
    }, [people, token, page, rowsPerPage, filterValue, tipoActividad, descripcionActividad, dispatch, setLoading, handleGetData, setTipoActividad, encryptMessage, decryptMessage, setDialogCreate, handleGetDataSearch, setDescripcionActividad]);
    ...
    }, [people, token, page, rowsPerPage, filterValue, selectedData, tipoActividad, descripcionActividad, dispatch, setLoading, handleGetData, setTipoActividad, encryptMessage, decryptMessage, setDialogUpdate, handleGetDataSearch, setDescripcionActividad]);
            ...
            <Dialog open={dialogDelete} onClose={() => setDialogDelete(false)} maxWidth='md' fullScreen={fullScreen}>
                ...
                <DialogContent>
                    {selectedData === null ? (
                        ...
                        <Fragment>
                            <Typography textAlign={'justify'}>¿Esta seguro de eliminar la festividad <b>{items.filter(x => String(x.value) === String(decryptMessage(selectedData.tipo_tradicion)))[0].item}</b> del sistema?, una vez eliminada deberá crearla nuevamente si desea restablecerla.</Typography>
