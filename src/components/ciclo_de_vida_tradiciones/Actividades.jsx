...
const Actividades = ({ people, viewOnly }) => {
    ...
    }, [people, token, page, rowsPerPage, filterValue, template, tipoActividad, descripcionActividad, dispatch, setLoading, handleGetData, setTipoActividad, setDialogCreate, handleGetDataSearch, setDescripcionActividad]);
    ...
    }, [people, token, page, rowsPerPage, filterValue, template, selectedData, tipoActividad, descripcionActividad, dispatch, setLoading, handleGetData, setTipoActividad, setDialogUpdate, handleGetDataSearch, setDescripcionActividad]);
            ...
            <Dialog open={dialogDelete} onClose={() => setDialogDelete(false)} maxWidth='md' fullScreen={fullScreen}>
                ...
                <DialogContent>
                    {selectedData === null ? (
                        ...
                        <Fragment>
                            <Typography textAlign={'justify'}>¿Esta seguro de eliminar la actividad <b>{items.filter(x => String(x.value) === String(selectedData.tipo_tradicion))[0].item}</b> del sistema?, una vez eliminada deberá crearla nuevamente si desea restablecerla.</Typography>
